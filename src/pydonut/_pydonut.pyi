...
class RootFileSystem(IFileSystem):
    ...
    def mount(self: RootFileSystem, path: str, nativePath: str) -> None: ...

class ShaderFactory():
    def __init__(self: ShaderFactory, device: Device, fs: IFileSystem, basePath: str) -> None: ...
...
class TextureCache():
    ...
    def LoadTextureFromFile(self: TextureCache, path: str, sRGB: bool, passes: Optional[CommonRenderPasses], commandList: CommandList) -> LoadedTexture: ...
