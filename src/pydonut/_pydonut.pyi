...
def RenderView(commandList: CommandList, view: PlanarView, viewPrev: PlanarView, framebuffer: Framebuffer, drawStrategy: PassthroughDrawStrategy, pass_: GBufferFillPass, context: GBufferFillPassContext, materialEvents: bool = False) -> None: ...
